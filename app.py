...
# ---------------------------------------------------------
    ...
    if paso == 0:
        ...
        for idx, r in enumerate(rifas_list):
            ...
            # INCREMENTO EXACTO DE 1% POR CADA 100 BOLETOS VENDIDOS (SIN DECIMALES)
            progreso_porcentaje = int(vendidos // 100)
            progreso_float = progreso_porcentaje / 100.0
            ...
            with cols_rifa[idx]:
                ...
                st.write(f"📊 **PROGRESO: {progreso_porcentaje}%**")
                st.progress(progreso_float)
